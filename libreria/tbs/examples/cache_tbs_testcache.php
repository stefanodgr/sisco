...
<div id="main-body">
  ...
  <div id="example">
    ...
    <table width="200" border="2" cellpadding="4" cellspacing="0" style="border-color:#336699; margin-left:auto; margin-right:auto;">
      <tr>
        <td align="center">Time of merging: <span class="text-example2">13:32:39</span></td>
      </tr>
    </table>
    <p style="text-align:center"><a href="tbs_us_examples_cache.php?">recall the page</a></p>
  </div>
</div>
</body>
</html>
