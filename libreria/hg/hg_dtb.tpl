...
<html>
	...
	<body>
		...
		<table id="tbl">
			<thead>
				<tr>
					<th id='[dtsTbl.header;noerr;]' name='[dtsTbl.encabezado;noerr;]' abbr='[dtsTbl.columna;noerr;]' class='[dtsTbl.tipo;noerr;] [dtsTbl.formato;noerr;] [dtsTbl.relacion;noerr;] [dtsTbl.default;noerr;] [dtsTbl.visible;noerr;]'><strong>[dtsTbl.encabezado;noerr;block=th]</strong></th>
				</tr>
			</thead>
			<tbody>
				<tr id='[data.id; sub1=(columna); block=tr; magnet=tr; noerr]'>
					<td>[data_sub1.val;block=td;noerr]</td>
				</tr>
			</tbody>
		</table>
		...
		<div id = 'control2' style="display:none;">
			<table id="tbl2" class="display" border="1" width="100%" bordercolor="#CCCCCC" style="font-size: 12px;font-family: sans-serif;background-color:#EFEFEF;">
				<thead>
					<tr >
						<th align="center"></th>
		...
		<div id = 'control5' 	style="display:none">
			<table id = 'tbl5' class="display tabla" border="1" bordercolor="#CCCCCC">
				<tr>
